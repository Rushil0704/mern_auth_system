        ...
        <>
            <nav className="w-full bg-white dark:bg-primaryBg border-b border-btnGrFromLight dark:border-darkBorder sm:px-6 sm:py-4 px-5 py-3 flex items-center justify-between shadow-sm z-50 sticky top-0">
                ...
                {isAuthenticated && (
                    <div className="hidden md:flex gap-8 text-lg font-medium">
                        <Link
                            to="/dashboard"
                            className={`border-b dark:hover:border-primary hover:border-gray-600 ${
                                location.pathname === "/dashboard"
                                    ? "border-b dark:border-textGrFrom border-gray-600"
                                    : ""
                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    {isAuthenticated && (
                        ...
                        >
                            ...
                            <Icon
                                icon="menu"
                                className="w-6 h-6 text-gray-500 dark:text-white flex justify-center items-center"
                                fill="none"
                                stroke="currentColor"
                                strokeWidth="2"
                            />
            ...
            </nav>
            {
                ...
                >
                    ...
                    {/* Sidebar */}
                    <div
                        className={`ml-auto w-[calc(100%/1)] sm:w-[calc(100%/3)] h-full bg-white dark:bg-primaryBg shadow-sm p-4 z-50 transform transition-transform duration-300 ease-in-out ${
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <div className="flex-1 overflow-y-auto space-y-6">
                                ...
                                <div className="md:hidden flex flex-col gap-3">
                                    <h3 className="text-md font-semibold text-gray-700 dark:text-btnGrFromLight">
                                        Navigation
                                    </h3>
                                    <Link
                                        to="/dashboard"
                                ...
                                {user && (
                                    <div className="border-t border-btnGrFromLight dark:border-darkBorder pt-4 w-full">
                                        <h3 className="text-md font-semibold text-gray-700 dark:text-blue-300 mb-2">
                                            User Settings
                                        </h3>
                                        <button
                                            onClick={() => {
                            ...
                            {user && (
                                <div className="flex items-center gap-3 border-t border-btnGrFromLight dark:border-darkBorder pt-4 sticky bottom-0 bg-white dark:bg-primaryBg justify-between">
                                    ...
                                    <div className="flex-col flex-1 hidden lg:flex">
                                        ...
                                        <span className="text-xs text-gray-500 dark:text-textGrayMedium">
                                            {user.email}
                                        </span>
                                    </div>
                                    <div
